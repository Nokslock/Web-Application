...
export default function DashboardFab({
  ...
  const inputClass =
    "w-full p-3.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl outline-none text-sm text-gray-700 dark:text-gray-200 transition-all focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 focus:bg-white dark:focus:bg-gray-900 placeholder:text-gray-400 dark:placeholder:text-gray-500";
    ...
    try {
      ...
      toast.success(
        stagedFiles.length > 1
          ? `${stagedFiles.length} files saved!`
          : "Item saved securely!",
      );
            ...
            >
              <div className="bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 p-4 shrink-0">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    onClick={() => setIsOpen(false)}
                    className="p-2 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600 transition text-gray-600 dark:text-gray-300"
                  >
                    <FaXmark />
                  </button>
                </div>
              ...
              >
                  ...
                  >
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <FaLock
                          className={`text-sm ${isLocked ? "text-amber-600" : "text-gray-400"}`}
                        />
                        <h4
                          className={`text-sm font-bold ${isLocked ? "text-amber-800 dark:text-amber-300" : "text-gray-700 dark:text-gray-300"}`}
                        >
                          Lock with Password
                        </h4>
                      </div>
                      <p
                        className={`text-xs mt-0.5 ${isLocked ? "text-amber-600/80 dark:text-amber-400/70" : "text-gray-500"}`}
                      >
                ...
                >
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <FaUserShield
                        className={`text-sm ${shareWithNok ? "text-blue-600" : "text-gray-400"}`}
                      />
                      <h4
                        className={`text-sm font-bold ${shareWithNok ? "text-blue-800 dark:text-blue-300" : "text-gray-700 dark:text-gray-300"}`}
                      >
                        Pass to Next of Kin
                      </h4>
                    </div>
