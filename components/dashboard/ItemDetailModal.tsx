    ...
    return (
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">
            This item is protected. Please enter your account password to verify
            your identity.
          </p>
    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <div className="relative overflow-hidden p-8 pb-6 shrink-0">
          ...
          <div
            className={`absolute top-0 right-0 w-64 h-64 ${colors.bg} blur-3xl rounded-full opacity-50 -translate-y-1/2 translate-x-1/2`}
          ></div>
            ...
            <div className="flex gap-5 items-center">
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span
                    className={`px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider ${colors.badgeBg} ${colors.badgeText}`}
                  >
                    {item.type}
                  </span>
                  {item.share_with_nok && (
          ...
          {(item.type === "card" || item.type === "crypto") && (
            <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${targetLockState ? "bg-amber-100 dark:bg-amber-900/40 text-amber-600 dark:text-amber-400" : "bg-gray-200 dark:bg-gray-700 text-gray-500"}`}
                >
                  {targetLockState ? (
                    <FaLock size={14} />
                  ) : (
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {targetLockState ? "Item is locked" : "Item is unlocked"}
                  </p>
                </div>
              </div>
              <button
              ...
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${targetLockState ? "translate-x-5" : "translate-x-0"}`}
                />
              </button>
            </div>
          )}
            ...
            return (
              ...
              >
                ...
                <div className="relative group">
                  <input
                    type={
                      isSecret ? (showSensitive ? "text" : "password") : "text"
                    }
                    value={value}
            ...
            >
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-xs text-gray-500 font-medium mt-1">
                  {(decryptedDetails.fileSize / 1024).toFixed(1)} KB • Secure
                  Storage
                </p>
              </div>
              <button
